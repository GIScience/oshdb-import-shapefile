# OSHDB Import Shapefile

The script is meant to convert a shapefile into an OSHDB H2 database file.  The script needs to be improved.
...
The code is licensed under the [GNU GPL license](https://github.com/giscience/oshdb-import-shapefile/blob/master/LICENSE).
